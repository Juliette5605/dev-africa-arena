<?php $__env->startSection('title', 'Nos Sponsors | DevAfrica Arena'); ?>
...
<section class="py-5">
    <div class="container">
        ...
        <div class="cta-box text-center" data-aos="zoom-in">
            <h2 class="fw-bold mb-3">Prêt à devenir un partenaire clé ?</h2>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 rounded-4 overflow-hidden shadow-lg">
            ...
            <div class="modal-body p-4 pt-0">
                <form action="<?php echo e(route('partenaires.sponsors.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\devafrica-arena-laravel-FULL\arena-laravel\resources\views/pages/partenaires-sponsors.blade.php ENDPATH**/ ?>