    ...
    <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:20px;overflow:hidden;box-shadow:0 10px 40px rgba(0,0,0,0.08);">
      ...
      <tr>
        <td style="padding:50px;">
          <p style="color:#666;font-size:15px;line-height:1.8;margin:0 0 25px;">
            Bonjour <?php echo e($subscriber->nom ?? 'talent'); ?>, vous êtes maintenant dans la liste exclusive des personnes qui suivent <strong>DevAfrica Arena</strong> — le premier championnat technologique d'Afrique de l'Ouest.
          </p>
          ...
          <div style="text-align:center;margin-top:35px;">
            <a href="<?php echo e(config('app.url')); ?>/criteres" style="display:inline-block;background:linear-gradient(135deg,#f39c12,#e67e22);color:#fff;text-decoration:none;padding:16px 40px;border-radius:50px;font-weight:800;font-size:15px;">
              Postuler maintenant →
            </a>
          </div>
        </td>
      ...
      <tr>
        <td style="background:#222;padding:25px 50px;text-align:center;">
          <p style="margin:0;color:rgba(255,255,255,0.4);font-size:11px;">© <?php echo e(date('Y')); ?> DevAfrica Arena · Lomé, Togo · <a href="<?php echo e(config('app.url')); ?>" style="color:#f39c12;">devafricaarena.com</a></p>
        </td>
      </tr>
    </table>
  </td></tr>
...
<?php /**PATH C:\Users\Lenovo\Desktop\dev-africa-arena\resources\views/emails/newsletter-welcome.blade.php ENDPATH**/ ?>