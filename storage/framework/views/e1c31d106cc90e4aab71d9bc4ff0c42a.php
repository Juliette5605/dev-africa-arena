    ...
    <div class="login-card">
        ...
        <form action="<?php echo e(route('admin.login.post')); ?>" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>" placeholder="admin@devafricaarena.ai" required autofocus>
            </div>
...
<?php /**PATH C:\devafrica-arena-laravel-FULL\arena-laravel\resources\views/admin/login.blade.php ENDPATH**/ ?>