        ...
        <div class="row align-items-center">
            <div class="col-lg-6" data-aos="fade-right">
                ...
                <div class="d-flex flex-wrap gap-3">
                    ...
                    <a href="<?php echo e(route('a-propos')); ?>" class="btn btn-outline-dark" style="border-radius:15px; padding:15px 35px; font-weight:700;">
                        Découvrir
                    </a>
                </div>
            </div>
...
<section class="jobs-section">
    <div class="container">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-end mb-4 gap-3">
            ...
            <div data-aos="fade-left">
                <span class="jobs-count-pill">
                    ...
                    <span id="jobs-shown-count"><?php echo e(min(6, count($opportunities))); ?></span> / <?php echo e(count($opportunities)); ?> offres
                </span>
            </div>
        </div>
        ...
        <div class="jobs-scroll-wrapper" data-aos="fade-up">
            ...
            <div class="jobs-scroll-inner" id="jobs-scroll-inner">
                <div class="row g-3" id="jobs-grid">
                    <?php $__currentLoopData = array_slice($opportunities, 0, 6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $opportunity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-6 col-lg-4" style="animation: cardSlideIn 0.4s <?php echo e($i * 0.07); ?>s both;">
                        <div class="job-card">
                            <span class="job-card-tag">Tech</span>
                            <h5><?php echo e($opportunity['name'] ?? $opportunity['title'] ?? 'Offre Tech'); ?></h5>
                            <p class="job-company">
                                <i class="bi bi-building"></i>
                                <?php echo e($opportunity['company']['name'] ?? $opportunity['company_name'] ?? 'Entreprise'); ?>
                            ...
                            <div class="job-card-footer">
                                ...
                                <a href="<?php echo e($opportunity['refs']['landing_page'] ?? $opportunity['url'] ?? '#'); ?>"
                                   target="_blank"
                                   class="btn-job-view">
        ...
        <?php if(count($opportunities) > 6): ?>
        <div class="text-center mt-4" data-aos="fade-up">
            <button id="see-more-btn" class="btn-see-more">
                <i class="bi bi-plus-circle-fill"></i>
                Voir plus d'offres
                <span class="remaining-badge" id="remaining-badge">+<?php echo e(count($opportunities) - 6); ?></span>
            </button>
        </div>
        <?php endif; ?>
...
// ─── JOBS : VOIR PLUS ──────────────────────────────────────────
(function () {
    const allJobs    = <?php echo json_encode($opportunities, 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Desktop\dev-africa-arena\resources\views/pages/home.blade.php ENDPATH**/ ?>