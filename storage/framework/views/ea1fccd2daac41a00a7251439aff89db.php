...
<style>
    ...
    .main-card { background:#ffffff22;border-radius:40px;padding:60px;margin-top:-60px;box-shadow:0 20px 50px rgba(0,0,0,0.05);border:1px solid rgba(0,0,0,0.02);position:relative;z-index:2; }
    ...
    .f-card { background:#fcfcfc0f;padding:40px;border-radius:25px;border:1px solid #f0f0f0;transition:0.4s;height:100%; }
