...
<?php $__env->startSection('title', 'Partenariat Technique | DevAfrica Arena'); ?>
...
#techModal .form-control,
#techModal .form-select {
    ...
    <div class="container">
        <div class="row align-items-center mb-5 g-5">
            ...
            <div class="col-lg-6" data-aos="fade-left">
                <div class="tech-box">
                    <h4 class="fw-bold mb-3" style="color: rgb(7, 7, 7) !important;"><i class="bi bi-shield-lock text-warning me-2"></i>Immersion Totale</h4>
                    <p class="mb-0 text-muted" style="color: rgb(101, 101, 101) !important;">Intégrez vos solutions (Cloud, DevTools, Réseaux) au cœur des projets développés par les candidats et testez leur robustesse en temps réel.</p>
                </div>
            </div>
        </div>
        <div class="row g-4 mb-5">
            <div class="col-md-3" data-aos="fade-up" data-aos-delay="100">
                <div class="benefit-card">
                    <i class="bi bi-cpu" style="color: #e67e22"></i>
                    <h5 class="fw-bold" style="color: rgb(8, 8, 8) !important;">Benchmark</h5>
                    <p class="small text-muted mb-0" style="color: rgb(101, 101, 101) !important;">Prouvez la performance de vos outils face aux défis les plus complexes.</p>
                </div>
            </div>
            <div class="col-md-3" data-aos="fade-up" data-aos-delay="200">
                <div class="benefit-card">
                    <i class="bi bi-rocket-takeoff" style="color: #e67e22"></i>
                    <h5 class="fw-bold" style="color: rgb(8, 8, 8) !important;">Early Adopters</h5>
                    <p class="small text-muted mb-0" style="color: rgb(101, 101, 101) !important;">Faites adopter vos technologies par les futurs leaders de la tech.</p>
                </div>
            </div>
            <div class="col-md-3" data-aos="fade-up" data-aos-delay="300">
                <div class="benefit-card">
                    <i class="bi bi-search" style="color: #e67e22"></i>
                    <h5 class="fw-bold" style="color: rgb(8, 8, 8) !important;">Sourcing VIP</h5>
                    <p class="small text-muted mb-0" style="color: rgb(101, 101, 101) !important;">Repérez et recrutez les talents qui maîtrisent déjà votre stack.</p>
                </div>
            </div>
            <div class="col-md-3" data-aos="fade-up" data-aos-delay="400">
                <div class="benefit-card">
                    <i class="bi bi-broadcast-pin" style="color: #e67e22"></i>
                    <h5 class="fw-bold" style="color: rgb(8, 8, 8) !important;">Branding Tech</h5>
                    <p class="small text-muted mb-0" style="color: rgb(101, 101, 101) !important;">Renforcez votre image d'expert et d'innovateur engagé.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-5">
    <div class="container">
        <div class="contact-card text-center" data-aos="zoom-in">
            <h2 class="fw-bold mb-4" style="color: rgb(8, 8, 8);">Prêt à co-construire l'Arena ?</h2>
            <p class="lead opacity-75 mb-5 mx-auto" style="max-width:700px; color:rgb(93, 93, 93)">
...
<div class="modal fade" id="techModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 rounded-4 overflow-hidden">
            ...
            <div class="modal-body p-4 pt-0">
                <form action="<?php echo e(route('partenaires.techniques.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
    ...
    <input type="email" name="email" class="form-control py-3 bg-light border-0 shadow-none" required>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\dev-africa-arena\resources\views/pages/partenaires-techniques.blade.php ENDPATH**/ ?>