            ...
            <div class="col-lg-5">
                ...
                <div class="participant-card mb-3" data-aos="zoom-in" style="border: 2px solid #f39c12; background: #fffcf5;">
                    ...
                    <div class="input-group mb-2">
                        <input type="text" class="form-control bg-white" value="<?php echo e($voteUrl); ?>" id="voteInput" readonly style="border-radius: 12px 0 0 12px; border-color: #f39c12;">
                        <button class="btn btn-gold" type="button" onclick="copyVoteLink()" style="border-radius: 0 12px 12px 0;">
                            <i class="bi bi-clipboard"></i>
                        </button>
                    </div>
                    <div class="d-grid">
                        <a href="https://wa.me/?text=<?php echo e(urlencode('Soutenez-moi pour le concours DevAfricaArena en votant pour mon profil ici : ' . $voteUrl)); ?>" target="_blank" class="btn btn-success rounded-pill btn-sm">
                ...
                <div class="participant-card mb-3" data-aos="fade-up" data-aos-delay="130">
                    ...
                    <?php if($candidature && ($candidature->score_ia || $candidature->analyse_ia)): ?>
                        <?php
                        ...
                        <div class="mb-3 p-3 rounded-4" style="background:rgba(2,132,199,0.04);border:1px solid rgba(2,132,199,0.12);">
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                                ...
                                <?php if($candidature->score_ia): ?>
                                    <span class="mini-badge" style="background:<?php echo e($aiScore['bg']); ?>;color:<?php echo e($aiScore['color']); ?>;">
                                        <?php echo e($candidature->score_ia); ?>/5 · <?php echo e($aiScore['label']); ?>

                                    </span>
                                <?php endif; ?>
                            </div>

                            <?php if($candidature->analyse_ia): ?>
                                <p class="mb-0 mt-3 text-muted"><?php echo e($candidature->analyse_ia); ?></p>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
