      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 10px 40px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td style="background:#222;padding:30px 50px;text-align:center;">
            <p style="margin:0 0 5px;color:rgba(255,255,255,0.5);font-size:12px;">© <?php echo e(date('Y')); ?> DevAfricaArena — Lomé, Togo</p>
...
<?php /**PATH C:\devafrica-arena-laravel-FULL\arena-laravel\resources\views/emails/candidature-confirmation.blade.php ENDPATH**/ ?>