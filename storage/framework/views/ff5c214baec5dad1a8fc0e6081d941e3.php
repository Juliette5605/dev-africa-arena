...
<body>
    ...
    <script>
        const initialMode = <?php echo json_encode($authMode ?? 'login', 15, 512) ?>;
        const csrfRefreshUrl = <?php echo json_encode(route('csrf.refresh'), 15, 512) ?>;
...
<?php /**PATH C:\devafrica-arena-laravel-FULL\arena-laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>