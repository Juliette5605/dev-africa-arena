...
<section class="partners-bar text-center">
    <div class="container" data-aos="fade-up">
        ...
        <div class="d-flex justify-content-center align-items-center">
            <img src="<?php echo e(asset('assets/logo_saei-removebg-preview.png')); ?>" alt="SAEI CUBE" class="partner-logo-single">
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\dev-africa-arena-master\resources\views/pages/home.blade.php ENDPATH**/ ?>