...
<?php $__env->startSection('title', 'TalentSync IA'); ?>
        ...
        <div class="admin-card p-4">
            ...
            <select id="candidature-select" class="form-select rounded-3 border-0 bg-light py-3 mb-3">
                ...
                <option value="<?php echo e($c->id); ?>"
                        data-nom="<?php echo e($c->prenom); ?> <?php echo e($c->nom); ?>"
                        data-expertise="<?php echo e($c->expertise); ?>"
                        data-niveau="<?php echo e($c->niveau); ?>"
                        data-pays="<?php echo e($c->pays); ?>">
                    <?php echo e($c->prenom); ?> <?php echo e($c->nom); ?> — <?php echo e($c->niveau); ?>
...
<script>
const ROUTES = {
    cv:     '<?php echo e(route("admin.talentsync.cv")); ?>',
    letter: '<?php echo e(route("admin.talentsync.letter")); ?>',
    match:  '<?php echo e(route("admin.talentsync.match")); ?>',
    apply:  '<?php echo e(route("admin.talentsync.apply")); ?>',
    status: '<?php echo e(route("admin.talentsync.status")); ?>',
};
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\dev-africa-arena\resources\views/admin/talentsync/index.blade.php ENDPATH**/ ?>