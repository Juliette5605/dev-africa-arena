            ...
            <div class="collapse navbar-collapse" id="navMenu">
                <ul class="navbar-nav ms-auto align-items-center gap-1">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle <?php echo e(request()->routeIs('dashboard') || request()->routeIs('quiz.*') || request()->routeIs('forum.*') || request()->routeIs('vote.*') ? 'active' : ''); ?>" href="#" data-bs-toggle="dropdown">
                                Arena
                            </a>
                            <ul class="dropdown-menu border-0 shadow-sm rounded-4 p-2">
                                <li><a class="dropdown-item rounded-3 fw-semibold py-2" href="<?php echo e(route('dashboard')); ?>">
                                    <i class="bi bi-grid me-2 text-muted"></i>Mon Dashboard
                                </a></li>
                                <li><a class="dropdown-item rounded-3 fw-semibold py-2" href="<?php echo e(route('quiz.play')); ?>">
                                    <i class="bi bi-lightning me-2 text-muted"></i>Quiz Arena
                                </a></li>
                                <li><a class="dropdown-item rounded-3 fw-semibold py-2" href="<?php echo e(route('forum.index')); ?>">
                                    <i class="bi bi-chat-dots me-2 text-muted"></i>Forum Arena
                                </a></li>
                                <li><hr class="dropdown-divider mx-2 my-1"></li>
                                <li><a class="dropdown-item rounded-3 fw-semibold py-2" href="<?php echo e(route('vote.leaderboard')); ?>"
                                       style="color: #f39c12;">
                        ...
                        <li class="nav-item">
                            <a class="btn btn-gold py-2 px-4" href="<?php echo e(route('contact')); ?>"
    ...
    <div class="auth-card">
        ...
        <div class="auth-body">
            ...
            <div class="auth-error">
                <i class="bi bi-exclamation-triangle me-1"></i> <?php echo e($errors->first()); ?>
...
const csrfRefreshUrl = '<?php echo e(route("csrf.refresh")); ?>';
...
<?php if($errors->any()): ?>
document.addEventListener('DOMContentLoaded', () => openAuth('<?php echo e(session("authMode", "login")); ?>'));
<?php endif; ?>
</script>
...
</html><?php /**PATH C:\Users\USER\Desktop\dev-africa-arena\resources\views/layouts/app.blade.php ENDPATH**/ ?>