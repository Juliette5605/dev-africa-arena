...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box;}
        ...
        /* MAINTENANCE BANNER */
        <?php $maintenanceOn = \App\Models\Setting::get('maintenance_mode') === '1'; ?>
        <?php if($maintenanceOn ?? false): ?>
...
<aside class="sidebar">
    ...
    <div class="sidebar-section">
        ...
        <a href="<?php echo e(route('admin.talentsync')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.talentsync*') ? 'active' : ''); ?>">
            TalentSync IA
        </a>
...
<?php /**PATH C:\devafrica-arena-laravel-FULL\arena-laravel\resources\views/admin/layout.blade.php ENDPATH**/ ?>