...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> — DevAfricaArena</title>
...
<div style="background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;text-align:center;padding:8px;font-weight:700;font-size:0.82rem;position:fixed;top:0;left:0;right:0;z-index:999;">
    ...
    <a href="<?php echo e(route('admin.settings')); ?>" style="color:rgba(255,255,255,0.8);margin-left:8px;text-decoration:underline;">Désactiver →</a>
</div>
    ...
    <div class="sidebar-scroll">
        <div class="sidebar-section">
            ...
            <a href="<?php echo e(route('admin.candidatures')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.candidatures*') ? 'active' : ''); ?>">
                ...
                <?php if($unread_candidatures > 0): ?>
                    <span class="sidebar-badge" style="background:#ef4444;color:white;"><?php echo e($unread_candidatures); ?> new</span>
                <?php else: ?>
                    <span class="sidebar-badge"><?php echo e(\App\Models\Candidature::count()); ?></span>
                <?php endif; ?>
            </a>
            ...
            <a href="<?php echo e(route('admin.partenaires')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.partenaires*') ? 'active' : ''); ?>">
                ...
                <span class="sidebar-badge"><?php echo e(\App\Models\Partenaire::count()); ?></span>
            </a>
            <a href="<?php echo e(route('admin.messages')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.messages*') ? 'active' : ''); ?>">
                <i class="bi bi-chat-dots-fill"></i> Messages
                <?php if($unread_messages > 0): ?>
                    <span class="sidebar-badge" style="background:#ef4444;color:white;"><?php echo e($unread_messages); ?> new</span>
                <?php else: ?>
                    <span class="sidebar-badge"><?php echo e(\App\Models\ContactMessage::count()); ?></span>
                <?php endif; ?>
            </a>
        </div>
        ...
        <div class="sidebar-section">
            ...
            <a href="<?php echo e(route('admin.newsletters')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.newsletters*') ? 'active' : ''); ?>">
                ...
                <span class="sidebar-badge"><?php echo e(\App\Models\Newsletter::count()); ?></span>
            </a>
            ...
            <a href="<?php echo e(route('admin.votes.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.votes*') ? 'active' : ''); ?>"
               style="<?php echo e(request()->routeIs('admin.votes*') ? '' : 'color:rgba(243,156,18,0.8);'); ?>">
                <i class="bi bi-trophy-fill"></i> Votes & Classement
                <span class="sidebar-badge" style="background:rgba(243,156,18,0.2);color:#f39c12;">
                    <?php echo e(\App\Models\Vote::where('status','confirmed')->count()); ?>
        ...
        <div class="sidebar-section">
            ...
            <a href="<?php echo e(route('admin.devafricaarena')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.devafricaarena*') ? 'active' : ''); ?>">
                <i class="bi bi-cpu-fill"></i> DevAfricaArena
            </a>
            <a href="<?php echo e(route('admin.qrcode')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.qrcode') ? 'active' : ''); ?>">
        ...
        <div class="sidebar-section">
            ...
            <a href="<?php echo e(route('admin.admins.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.admins*') ? 'active' : ''); ?>">
                ...
                <span class="sidebar-badge"><?php echo e(\App\Models\Admin::where('role','sub')->count()); ?>/2</span>
            </a>
            <a href="<?php echo e(route('admin.smtp')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.smtp*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.settings')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.settings*') ? 'active' : ''); ?>">
                ...
                <?php if($maintenanceOn): ?><span class="sidebar-badge" style="background:#ef4444;color:white;">🚧</span><?php endif; ?>
            </a>
        </div>
        <?php endif; ?>
    </div>
        ...
        <div class="px-2 mb-3">
            ...
            <?php else: ?>
                <span class="badge w-100 py-2 rounded-3 fw-bold" style="background:rgba(107,114,128,0.15);color:#9ca3af;font-size:0.68rem;">
                    <?php echo e(auth('admin')->user()?->can_edit ? '✅ Délégation active' : '🔒 Lecture seule'); ?>
...
<div class="main-content">
    <div class="topbar">
        ...
        <div class="d-flex align-items-center gap-3">
            <?php if($unread_candidatures + $unread_messages > 0): ?>
            <a href="<?php echo e(route('admin.candidatures', ['lu'=>'non'])); ?>" class="text-decoration-none">
                <span class="badge rounded-pill fw-bold px-3 py-2" style="background:rgba(239,68,68,0.1);color:#ef4444;">
                    <i class="bi bi-bell-fill me-1"></i><?php echo e($unread_candidatures + $unread_messages); ?> non lus
                </span>
            </a>
            <?php endif; ?>
...
</html><?php /**PATH C:\devafrica-arena-laravel-FULL\arena-laravel\resources\views/admin/layout.blade.php ENDPATH**/ ?>