...
<?php $__env->startSection('title', 'À Propos | DevAfricaArena - L\'Intelligence des Talents'); ?>
            ...
            <div class="col-lg-6" data-aos="fade-left">
                <div class="card-glass">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-3"><i class="bi bi-check-circle-fill text-warning me-2"></i> Identifier l'excellence technique sur le marché.</li>
                        <li class="mb-3"><i class="bi bi-check-circle-fill text-warning me-2"></i> Optimiser le processus de recrutement tech.</li>
                        <li class="mb-3"><i class="bi bi-check-circle-fill text-warning me-2"></i> Digitaliser le suivi de carrière des développeurs.</li>
                        <li><i class="bi bi-check-circle-fill text-warning me-2"></i> Propulser l'innovation locale à l'international.</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4">
            <div class="col-md-6" data-aos="fade-up">
                <div class="card-glass">
                    ...
                    <h4 class="fw-bold">Audit Technique</h4>
                    <p class="text-muted small"><strong>Tests Algorithmiques</strong><br>Analyse approfondie de la logique de code et de la résolution de problèmes complexes.</p>
                    <p class="text-muted small"><strong>Profilage de Compétences</strong><br>Cartographie précise de votre stack technologique et de votre niveau d'expertise.</p>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\devafrica-arena-laravel-FULL\arena-laravel\resources\views/pages/a-propos.blade.php ENDPATH**/ ?>