...
<?php $__env->startSection('page-title', ' QR Code Candidature'); ?>
    ...
    <div class="col-lg-6">
        <div class="admin-card p-5 text-center">
            ...
            <div class="p-3 rounded-3 mb-4" style="background:#f8f9fa;word-break:break-all;">
                <code style="font-size:0.85rem;color:#f39c12;"><?php echo e($url); ?></code>
            </div>
            ...
            <div class="d-flex gap-3 justify-content-center flex-wrap">
                ...
                <button onclick="navigator.clipboard.writeText('<?php echo e($url); ?>').then(()=>alert('Lien copié !'))"
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\devafrica-arena-laravel-FULL\arena-laravel\resources\views/admin/qrcode.blade.php ENDPATH**/ ?>