...
<style>
    ...
    .main-card { background:#ffffff00;border-radius:40px;padding:60px;margin-top:-60px;box-shadow:0 20px 50px rgba(0,0,0,0.05);border:1px solid rgba(0,0,0,0.02);position:relative;z-index:2; }
    ...
    .f-card { background:#fcfcfc75;padding:40px;border-radius:25px;border:1px solid #f0f0f0;transition:0.4s;height:100%; }
                ...
                <table class="table align-middle">
                    <thead>
                        <tr>
                            ...
                            <th>Approche DevAfrica Arena (Actif)</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\TalentSync AI\resources\views/pages/argument.blade.php ENDPATH**/ ?>