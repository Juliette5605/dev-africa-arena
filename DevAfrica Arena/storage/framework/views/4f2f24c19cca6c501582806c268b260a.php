    ...
    <div class="content-wrapper">
        <header class="py-5 mt-5 text-center">
            <div class="container">
                ...
                <h1 class="display-4 fw-bold mb-3" data-aos="fade-up">Critères de <span
                        class="text-gradient">Sélection</span></h1>
            </div>
        </header>
        ...
        <section class="container">
            <div class="registration-box" data-aos="zoom-in">
                ...
                <form action="<?php echo e(route('criteres.store')); ?>" method="POST"></form>
                <?php echo csrf_field(); ?>
                <div class="row g-4">
                    <div class="col-md-6">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\TalentSync AI\resources\views/pages/criteres.blade.php ENDPATH**/ ?>