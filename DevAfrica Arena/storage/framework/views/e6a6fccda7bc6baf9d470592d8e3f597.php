        ...
        <div class="row align-items-center">
            <div class="col-lg-6" data-aos="fade-right">
                ...
                <div class="d-flex flex-wrap gap-3">
                    ...
                    <a href="<?php echo e(route('a-propos')); ?>" class="btn btn-outline-dark" style="border-radius:15px; padding:15px 35px; font-weight:700;background:white; color:#111">
                        Découvrir
                    </a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\TalentSync AI\resources\views/pages/home.blade.php ENDPATH**/ ?>