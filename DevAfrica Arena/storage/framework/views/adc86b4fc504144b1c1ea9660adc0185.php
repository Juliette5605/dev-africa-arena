...
<style>
    ...
    .card-glass {
        background: rgba(255, 255, 255, 0.283); border: 1px solid rgba(0,0,0,0.08);
    ...
    .icon-box {
        width:60px;height:60px; background:#f9cb69eb;; color:var(--gold);
    ...
    <header class="text-center" style="padding:160px 0 60px;">
        <div class="container">
            ...
            <p class="lead text-muted mx-auto" style="max-width:800px;" data-aos="fade-up" data-aos-delay="100">
                DevAfrica Arena n'est pas qu'une plateforme de plus. C'est une révolution dans la manière d'évaluer, de connecter et de propulser les talents technologiques en Afrique grâce à l'intelligence de données.
            </p>
        </div>
    </header>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\TalentSync AI\resources\views/pages/valeurs.blade.php ENDPATH**/ ?>