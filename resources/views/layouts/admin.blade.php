...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.candidatures') }}" class="nav-link {{ request()->routeIs('admin.candidatures*') ? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.finalistes') }}" class="nav-link {{ request()->routeIs('admin.finalistes') ? 'active' : '' }}">
                    <i class="fas fa-star"></i>
                    <span>Finalistes</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('admin.partenaires') }}" class="nav-link {{ request()->routeIs('admin.partenaires*') ? 'active' : '' }}">
                    <i class="fas fa-handshake"></i>
                    <span>Partenaires</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('admin.newsletters') }}" class="nav-link {{ request()->routeIs('admin.newsletters*') ? 'active' : '' }}">
        ...
        <nav class="top-navbar">
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="user-menu">
                        <div class="user-info">
                            <p class="user-name">{{ auth('admin')->user()->name ?? 'Admin' }}</p>
