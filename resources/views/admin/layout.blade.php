...
<head>
    ...
    <title>@yield('title', 'Admin') — TalentSync AI</title>
...
<div style="background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;text-align:center;padding:8px;font-weight:700;font-size:0.82rem;position:fixed;top:0;left:0;right:0;z-index:999;">
    🚧 MODE MAINTENANCE ACTIF — TalentSync AI est en pause.
    <a href="{{ route('admin.settings') }}" style="color:#fff;margin-left:8px;text-decoration:underline;">Gérer →</a>
</div>
...
<aside class="sidebar">
    ...
    <div class="sidebar-section">
        ...
        <a href="{{ route('admin.candidatures') }}" class="sidebar-link {{ request()->routeIs('admin.candidatures*') ? 'active' : '' }}">
            ...
            <span class="sidebar-badge {{ $unread_candidatures > 0 ? 'bg-danger text-white' : '' }}">
                {{ $unread_candidatures > 0 ? $unread_candidatures . ' new' : \App\Models\Candidature::count() }}
            </span>
        </a>
        ...
        <a href="{{ route('admin.messages') }}" class="sidebar-link {{ request()->routeIs('admin.messages*') ? 'active' : '' }}">
            ...
            @if($unread_messages > 0)
                <span class="sidebar-badge bg-danger text-white">{{ $unread_messages }}</span>
            @endif
        </a>
    </div>
    ...
    <div class="sidebar-footer">
        <a href="{{ route('admin.profile') }}" class="sidebar-link mb-2">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <a href="{{ route('admin.candidatures', ['lu'=>'non']) }}" class="text-decoration-none">
                <span class="badge rounded-pill fw-bold px-3 py-2" style="background:rgba(239,68,68,0.1);color:#ef4444;">
                    <i class="bi bi-bell-fill me-1"></i>{{ $total_alerts }} alertes
                </span>
            </a>
            @endif
