...
<head>
    ...
    <style>
        ...
        .field { flex: 1; min-width: 45%; margin-bottom: 10px; }
        ...
        .footer { background: #f8f9fa; padding: 16px 32px; text-align: center; font-size: 0.75rem; color: #888; border-top: 1px solid #eee; position: fixed; bottom: 0; width: 100%; }
