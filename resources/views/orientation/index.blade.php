...
@section('title', 'Orientation | DevAfricaArena')
        ...
        <div class="row g-4 mt-2">
            <div class="col-lg-5" data-aos="fade-up">
                <div class="orientation-assistant">
                    ...
                    <form action="{{ route('orientation.ask') }}" method="POST" class="orientation-form">
                        @csrf
            ...
            <div class="row align-items-center g-4">
                ...
                <div class="col-lg-4">
                    <div class="cta-actions justify-content-lg-end">
                        <a href="{{ route('criteres') }}" class="btn-gold">Voir les critères</a>
                        <a href="{{ route('contact') }}" class="btn-outline-gold" style="border-color:rgba(255,255,255,0.22);color:#fff;">
                            Parler à l'équipe
                        </a>
                    </div>
                </div>
